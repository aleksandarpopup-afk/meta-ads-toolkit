...
const T={
  sr:{
    ...
    m8t:"AI Report Generator", m8s:"Profesionalni izveštaj sa PDF exportom",
    ...
    rg_generating:"AI generiše izveštaj...",
    ...
    rg_metric:"Metrika",
    rg_change:"Promena",
    rg_aiComment:"AI komentar na poređenje",
  ...
  en:{
    ...
    m8t:"AI Report Generator", m8s:"Professional report with PDF export",
    ...
    rg_generating:"AI generating report...",
    ...
    rg_metric:"Metric",
    rg_change:"Change",
    rg_aiComment:"AI comment on comparison",
  ...
  if(!type) return <div>
    ...
    <div style={{display:"flex",flexDirection:"column",gap:14}}>
      <button onClick={()=>setType("single")} style={{background:"linear-gradient(135deg,rgba(99,102,241,0.2),rgba(99,102,241,0.08))",border:"1px solid rgba(99,102,241,0.4)",borderRadius:16,padding:"20px",textAlign:"left",cursor:"pointer",WebkitTapHighlightColor:"transparent"}}>
        ...
        <div style={{marginTop:12,color:C.acl,fontSize:12,fontWeight:700}}>🤖 AI + 📥 PDF →</div>
      </button>
